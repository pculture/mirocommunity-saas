...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteTierInfo.site_name'
        db.add_column('mirocommunity_saas_sitetierinfo', 'site_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SiteTierInfo.site_name'
        db.delete_column('mirocommunity_saas_sitetierinfo', 'site_name')
