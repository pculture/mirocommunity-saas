...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteTierInfo.winddown_email_sent'
        db.add_column('mirocommunity_saas_sitetierinfo', 'winddown_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteTierInfo.winddown_email_sent'
        db.delete_column('mirocommunity_saas_sitetierinfo', 'winddown_email_sent')
    ...
    models = {
        ...
        'mirocommunity_saas.sitetierinfo': {
            ...
            'winddown_email_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
